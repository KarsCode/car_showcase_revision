...
import { CarDeatilsProps } from '@/types'
            ...
            <div className='fixed inset-0 overflow-y-auto'>
                ...
                <div className='flex min-h-full items-center justify-center p-4 text-center'>
                    <Transition.Child as ={Fragment} 
                        ...
                        <Dialog.Panel className = "relative w-full max-w-lg max-h-[80vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl flex flex-col gap-5 transition-all" >
                            <button
                            type='button'
